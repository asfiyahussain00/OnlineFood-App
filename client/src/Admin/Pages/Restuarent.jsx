...
import UpdateRestuarent from '../Components/UpdateRestuarent';
...
setRestuarent(value)
  ...
  return (
    <div className="container">
      <div className="d-flex justify-content-between align-item-center my-2">
        <span className='text-dark fw-bold fs-4'> Restuarent </span>
  ...
  <tbody>
    ...
    <tr key={key}>
      ...
      <td style={{background:'white', color:'black'}}><UpdateRestuarent/>
